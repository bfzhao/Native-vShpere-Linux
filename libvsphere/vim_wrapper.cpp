...
vw1__GuestAuthentication GuestAuthManager::AcquireCredentialsInGuest(VirtualMachine vm, vw1__GuestAuthentication*  requestedAuth, int64*  sessionID)
{
...
std::string GuestFileManager::InitiateFileTransferToGuest(VirtualMachine vm, vw1__GuestAuthentication*  auth, char* guestFilePath, vw1__GuestFileAttributes*  fileAttributes, int64 fileSize, bool overwrite)
{
...
std::vector<vw1__GuestProcessInfo> GuestProcessManager::ListProcessesInGuest(VirtualMachine vm, vw1__GuestAuthentication*  auth, int sizepids, int64* pids)
{
...
int64 GuestProcessManager::StartProgramInGuest(VirtualMachine vm, vw1__GuestAuthentication*  auth, vw1__GuestProgramSpec*  spec)
{
	...
	{
		return static_cast<int64>(rsp.returnval);
	}

	throw get_last_error();
}

void GuestProcessManager::TerminateProcessInGuest(VirtualMachine vm, vw1__GuestAuthentication*  auth, int64 pid)
{
...
void HostMemorySystem::ReconfigureServiceConsoleReservation(int64 cfgBytes)
{
...
Task VirtualDiskManager::ExtendVirtualDisk_Task(char* name, Datacenter datacenter, int64 newCapacityKb, bool*  eagerZero)
{
...
vw1__DiskChangeInfo VirtualMachine::QueryChangedDiskAreas(VirtualMachineSnapshot snapshot, int deviceKey, int64 startOffset, char* changeId)
{
...
int64 HostSystem::QueryMemoryOverhead(int64 memorySize, int*  videoRamSize, int numVcpus)
{
...
int64 HostSystem::QueryMemoryOverheadEx(vw1__VirtualMachineConfigInfo*  vmConfigInfo)
{
...
int64 HostSystem::RetrieveHardwareUptime()
{
