...
public:
	...
	bool is_type_of(const char* type) const { return strcmpi(_mor->type, type) == 0; }
...
public:
	...
	static const char* type;
	vw1__GuestAuthentication AcquireCredentialsInGuest(VirtualMachine vm, vw1__GuestAuthentication*  requestedAuth, int64*  sessionID);
...
public:
	...
	std::string InitiateFileTransferToGuest(VirtualMachine vm, vw1__GuestAuthentication*  auth, char* guestFilePath, vw1__GuestFileAttributes*  fileAttributes, int64 fileSize, bool overwrite);
...
public:
	...
	static const char* type;
	std::vector<vw1__GuestProcessInfo> ListProcessesInGuest(VirtualMachine vm, vw1__GuestAuthentication*  auth, int sizepids, int64* pids);
	...
	int64 StartProgramInGuest(VirtualMachine vm, vw1__GuestAuthentication*  auth, vw1__GuestProgramSpec*  spec);
	void TerminateProcessInGuest(VirtualMachine vm, vw1__GuestAuthentication*  auth, int64 pid);
...
public:
	...
	static const char* type;
	void ReconfigureServiceConsoleReservation(int64 cfgBytes);
...
public:
	...
	Task ExtendVirtualDisk_Task(char* name, Datacenter datacenter, int64 newCapacityKb, bool*  eagerZero);
...
public:
	...
	vw1__DiskChangeInfo QueryChangedDiskAreas(VirtualMachineSnapshot snapshot, int deviceKey, int64 startOffset, char* changeId);
...
public:
	...
	int64 QueryMemoryOverhead(int64 memorySize, int*  videoRamSize, int numVcpus);
	int64 QueryMemoryOverheadEx(vw1__VirtualMachineConfigInfo*  vmConfigInfo);
